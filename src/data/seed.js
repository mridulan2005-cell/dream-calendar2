...
export const courses = [
  ...
  { id: 'DEP-301', code: 'DEP 301', title: 'Collaborative Project', type: 'Core', credits: 6, cohort: 'BDes 3', year: 'B.Des. 3 year', faculty: ['Sudhir Bhatia', 'Vinayak', 'Shilpa'], venue: 'B.Des 3', slots: ['M12'], durationWeeks: 1, dateRanges: [dr('2025-10-13', '2025-10-17')] },
